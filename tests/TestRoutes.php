...
class TestRoutes extends TestCase
{
    ...
    public function api_tables_query($params = [])
    {
        ...
        $ret = $this->getJson(route('api_tables_query'), $data)->toJson();
        return $ret;
    }
    ...
    public function outer_api_forms_detail($params = [])
    {
        ...
        $ret = $this->getJson(route('outer_api_forms_detail'), $data)->toJson();
        return $ret;
    }
    ...
    public function api_auto_attrs_query($params = [])
    {
        ...
        $ret = $this->getJson(route('api_auto_attrs_query'), $data)->toJson();
        return $ret;
    }
